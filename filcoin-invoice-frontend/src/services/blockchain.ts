...
// ─── Contract Addresses ─────────────────────────────────────────────────────
export const PPT_TOKEN_ADDRESS = "0xa46a3358345Dea8a6A62Fa1fc75AD2342c216767";
export const INVOICE_CONTRACT_ADDRESS = "0x13762B044Fb050e43bF6EcFD3431e5E9dA52AFC5"; // TODO: Replace with deployed address
...
export async function addFilecoinNetwork(): Promise<void> {
  const ethereum = getEthereum();
        ...
        params: [
          {
            ...
            chainName: FILECOIN_CALIBRATION.chainName,
            rpcUrls: FILECOIN_CALIBRATION.rpcUrls,
            blockExplorerUrls: FILECOIN_CALIBRATION.blockExplorerUrls,
            nativeCurrency: FILECOIN_CALIBRATION.nativeCurrency,
          },
        ],
      });
    } else {
...
export function getExplorerUrl(txHash: string): string {
  return `${FILECOIN_CALIBRATION.blockExplorerUrls[0]}/tx/${txHash}`;
}

export function getAddressExplorerUrl(address: string): string {
  return `${FILECOIN_CALIBRATION.blockExplorerUrls[0]}/address/${address}`;
}
