...
contract MedInvoiceContract is Ownable, ReentrancyGuard {
    ...
    function subscribe() external nonReentrant {
        ...
        // User must pay 10 PPT to subscribe (requires user to have called approve() first)
        require(pptToken.transferFrom(msg.sender, address(this), SUBSCRIPTION_AMOUNT), "Token transfer failed");
